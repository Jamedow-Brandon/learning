...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/static/css/water-fall.css"/>
</head>
<body>
<div id="container">
</div>
                ...
                htmlColumn = htmlColumn + '<span id="waterFallColumn_' + start + '" class="column" style="width:' + this.columnWidth + 'px;">' +
                    function () {
                        ...
                        for (i = 0; i < 5; i += 1) {
                            ...
                            html = html + '<a href="###" class="pic_a"><img src="' + self.rootImage + "P_" + index + '.jpg" /><strong>' + "测试商品XXX" + '</strong><strong style="float:right;">￥' + index + '.00</strong></a>';
                        }
                        return html;
                    }() +
                    '</span> ';
